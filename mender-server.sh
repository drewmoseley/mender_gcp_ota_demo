...
sudo usermod -a -G docker $USER
git clone https://github.com/Kcr19/mender-gcp-server.git
cd mender-gcp-server
cd production
...
./run pull
#35.226.60.114   mender.gcpotademo.com
#35.226.60.114   gcs.mender.gcpotademo.com
...
./run pull
sudo ./demo exec mender-useradm /usr/bin/useradm create-user --username=mender@example.com --password=Mender@2017
